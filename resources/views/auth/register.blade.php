                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5 style="color:#5a3d3d">Register Account</h5>
                                ...
                                <form action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password_confirmation" class="form-control"
                                            id="userCpassword" placeholder="Confirm password">
                                    </div>
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="text-muted mb-0">Already have an account ? <a
                                                href="{{ route('login') }}" class="font-weight-medium"
                                                style="color:#5a3d3d;"> Login</a></p>
                                    </div>
                                    {{--             
                                        <div class="mt-4 text-center">
                    ...
                    <div class="mt-5 text-center">
                        <p>© {{ date('Y') }} School Management System. Crafted with <i
                                ...
                                href="https://github.com/Thameshwarsahu/SchoolManagementSystem" target="_blank"
                                class="text-reset">Thameshwar sahu</a></p>
                    </div>
